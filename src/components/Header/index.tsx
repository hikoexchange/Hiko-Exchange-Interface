...
import Logo from '../../assets/svg/logo-hiko.png'
import LogoDark from '../../assets/svg/logo-hiko.png'
    ...
    <HeaderFrame>
      ...
      <HeaderRow>
        ...
        <HeaderLinks>
          ...
          <StyledHrefLink
            href="https://staking.hiko.exchange"
            target="_self"
            style={{ display: infoLink ? 'flex' : 'none' }}
          >
            {t('Staking')}
          </StyledHrefLink>
          ...
          <StyledHrefLink href={`#`} target="_self" style={{ display: infoLink ? 'flex' : 'none' }}>
            {t('Charts')}
          </StyledHrefLink>
