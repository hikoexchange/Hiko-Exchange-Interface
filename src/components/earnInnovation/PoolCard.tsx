...
import { StakingInfo } from '../../state/stakeInnovation/hooks'
    ...
    <Wrapper showBackground={isStaking} bgColor={backgroundColor}>
      ...
      <TopSection>
        ...
        <TYPE.white fontWeight={600} fontSize={24} style={{ marginLeft: '8px' }}>
          {currency0.symbol}-{currency1.symbol}-{stakingInfo.period}
        </TYPE.white>

        <StyledInternalLink
          to={`/dao-innovation-${stakingInfo.period}/${currencyId(token0.chainId, currency0)}/${currencyId(
            token0.chainId,
            currency1
          )}`}
          style={{ width: '100%' }}
